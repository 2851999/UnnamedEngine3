...
public:
    ...
    VertexBuffer(VulkanDevice* device, VkDeviceSize size, void* data, bool deviceLocal, bool persistentMapping) : VulkanBuffer(device, size, data, VK_BUFFER_USAGE_VERTEX_BUFFER_BIT, VK_SHARING_MODE_EXCLUSIVE, deviceLocal, persistentMapping) {}
